...
def pathSum(row,index):
    if row==14:
        return triangle[row][index]
    elif pathSum(row+1,index)>pathSum(row+1,index+1):
        return pathSum(row+1,index)+triangle[row][index]
    else:
        return pathSum(row+1,index+1)+triangle[row][index]
